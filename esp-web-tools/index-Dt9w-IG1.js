import{w as e,y as t,a as o,_ as i,t as l,i as n,x as a}from"./styles-sT2V1cOw.js?module";const s=e`
  <svg
    version="1.1"
    id="Capa_1"
...
`;let r=class extends n{render(){const e=(()=>{var e,t;const o=window.navigator.userAgent,i=(null===(t=null===(e=window.navigator)||void 0===e?void 0:e.userAgentData)||void 0===t?void 0:t.platform)||window.navigator.platform;return-1!==["macOS","Macintosh","MacIntel","MacPPC","Mac68K"].indexOf(i)?"Mac OS":-1!==["iPhone","iPad","iPod"].indexOf(i)?"iOS":-1!==["Win32","Win64","Windows","WinCE"].indexOf(i)?"Windows":/Android/.test(o)?"Android":/Linux/.test(i)?"Linux":null})();return a`
      <ew-dialog open @closed=${this._handleClose}>
        <div slot="headline">Nenhuma porta selecionada</div>
        <div slot="content">
          <div>
            Se a ESP32-S2 não apareceu na lista, verifique:
          </div>
          <ol>
            <li>
              A ESP32-S2 precisa estar conectada a este computador e reconhecida pelo sistema.
            </li>
            <li>
              Feche Arduino IDE, monitor serial ou outro programa que possa estar usando a porta.
            </li>
            <li>
              Se a placa não aparecer no Windows, instale o driver USB-serial correspondente.
            </li>
            ${"Linux"===e?a`
                  <li>
	                    No Linux, o usuário precisa estar no grupo
	                    <code>dialout</code> para acessar a porta serial.
                    <code class="block"
                      >sudo usermod -a -G dialout YourUserName</code
                    >
	                    Talvez seja necessário sair e entrar novamente para ativar a permissão.
                  </li>
                `:""}
            <li>
	              Drivers comuns para placas ESP:
              <ul>
                <li>
                  CP2102 drivers:
                  <a
